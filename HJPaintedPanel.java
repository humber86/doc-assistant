...
public class HJPaintedPanel extends JPanel {
    ...
    public HJPaintedPanel(LayoutManager manejadorDeLayout, Color colorRelleno1, Color colorRelleno2, Color colorBorde1, Color colorBorde2, int porcentaje, boolean esVertical) {
